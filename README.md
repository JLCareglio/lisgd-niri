...
device path.
There are also two places for debugging where my device is checked with
"IPTSD Virtual Touchscreen". You can replace your device name here for debugging purposes.
I compile with make WITHOUT_X11=1 since I have no intention of running X11 or XWayland
apps. You can just compile with make.
